            ...
            <div class="container">
                <div class="grid grid-cols-1 gap-4">
                    <div class=" text-white text-xl text-center pb-[45px]">
                        <img class="inline h-[200px] w-[246px]" src="<?php echo get_template_directory_uri();?>/images/thank-you.svg" />
                    </div>
                    <div class="">
                            ...
                            <div class="europe-box rounded-3xl mb-5">
                                    <div class="grid grid-cols-1">
                                        <div class="w-full lg:w-[100%] px-6 py-6">
                                            ...
                                            <div class="mt-12">
                                                <a href="https://calendly.com/smart-working/30min"> <h3 class="text-white text-xl font-bold leading-tight mb-3">Schedule a call </h3> </a>
