...
<div class="w-full relative calculate-sec grid items-center py-16" style="background-image: url('<?php echo get_template_directory_uri();?>/images/calc-bg.png');">
    <div class="container mx-auto md:px-0 px-10 min-h-[300px]">
		...
		<?php endif; ?>
      <div class="block mt-5 w-[100%] min-h-[300px] p-3 lg:px-[120px] lg:py-[60px] calc-sec-bg">
          <div class="grid grid-cols-1 lg:grid-cols-10 gap-5 content-center">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-5 content-center">
                  <div class="flex flex-row">
					  ...
					  <?php if(get_sub_field('box_heading_1')): ?>
                        <h3 class=" text-white text-[24px] font-medium mb-[16px]"><?php echo get_sub_field('box_heading_1'); ?></h3>
					  <?php endif; ?>	
                  ...
                  <div class="flex flex-row">
					  ...
					  <?php if(get_sub_field('box_heading_2')): ?>
                        <h3 class=" text-white text-[24px] font-medium mb-[16px]"><?php echo get_sub_field('box_heading_2'); ?></h3>
					  <?php endif; ?>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-5 mt-[60px] content-center">
                  <div class="flex flex-row">
					  ...
					  <?php if(get_sub_field('box_heading_3')): ?>
                        <h3 class=" text-white text-[24px] font-medium mb-[16px]"><?php echo get_sub_field('box_heading_3'); ?></h3>
					  <?php endif; ?>	
                  ...
                  <div class="flex flex-row">
					  ...
					  <?php if(get_sub_field('box_heading_4')): ?>
                        <h3 class=" text-white text-[24px] font-medium mb-[16px]"><?php echo get_sub_field('box_heading_4'); ?></h3>
					  <?php endif; ?>	
              ...
              <div class="grid-item col-span-4 content-start border-l border-[rgba(70,26,26,0.1)] text-center">
		  ...
		  <div class="grid grid-cols-1 gap-5 content-center mt-[40px]">
				<div>
    ...
    <div class="container mx-auto">
          <div class="show-more-box pt-[0px]">
            <div class="grid grid-cols-1 lg:grid-cols-10 gap-5 mt-5">
			  ...
			  <?php if(get_sub_field('right_cta_save_text')): ?>
