  	...
  	<div class=" w-full relative z-10">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 content-center gap-6 md:gap-32 relative z-10">
                        <div class="grid-item col-span-1">
                            <h1 class="font-medium text-[35px] md:text-[56px] mb-4 text-white  lg:leading-[74px]">
                                Hire pre-vetted senior
                                <span class="gradient-text">Python developers for</span>
                                <span class="text-dark-orange"> £20/hour.</span> 
                            </h1>
                            <p class=" text-white font-medium text-2xl pt-[10px] px-0 mb-10">Proven top 1% developers working your hours &amp; part of your team. Hire in a week.</p>
                            <div class="block">
        ...
        <!-- <section class="w-full px-3">
            <div class=" w-[100%] max-w-[800px] mx-auto py-16">
                <h1 class="text-center font-medium text-[35px] md:text-[56px] mb-4 text-white  lg:leading-[74px]">
                    Hire pre-vetted senior Python developers for <span class="text-dark-orange">£20/hour</span>. 
                </h1>
                <p class="text-center text-white font-medium text-2xl pt-[10px] px-0 mb-10">Proven top 1% developers working your hours & part of your team. Hire in a week.</p>
                <div class="block text-center">
                    <a href="#" class="button inline-block align-middle button-small rounded-[30px] px-8 py-4 border-dark-orange border-2 bg-dark-orange text-white text-[16px] hover:bg-transparent hover:text-dark-orange ">FIND YOUR PYTHON DEVELOPER</a>
            ...
            <div class=" w-[100%] max-w-[1280px] mx-auto py-16">
                <div class="block">
                    ...
                    <h2 class="text-4xl text-center font-medium text-[35px] md:text-[56px] mb-4 text-white  lg:leading-[60px]">
                        Meet Our Vetted	<span class="text-dark-orange block">Python Developers</span> 
                    </h2>
                    ...
                    <div class="grid-item col-span-3">
                        <div class="custom-bg custom-border">
                            <div class="flex items-center">
                                <img src="<?php echo get_template_directory_uri();?>/images/09.-Adam-Burrage-Managing-Director.png" alt="Author" class="w-16 h-16 rounded-full mr-4">
                                <div>
                                    <span class="text-white text-2xl font-medium block">Sara James</span>
                                    <span class="text-white text-sm font-normal block">Python Developer</span>
                                </div>
                            </div>
                            <div class="grid grid-cols-1 custom-grid-bg sm:grid-cols-2 gap-4 my-7 px-4 py-3 rounded-lg">
                                <div class="flex flex-col sm:flex-row">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-white text-base font-medium">5 years</p>
                                    </div>
                                </div>
                                <div class="flex flex-col sm:flex-row">
                            ...
                            <div class="block mb-3">
                                <ul class="card-skill">
                                    <li> aws <img src="<?php echo get_template_directory_uri();?>/images/aws.svg" alt="Technology 1" class="w-4 h-4 inline-block rounded-full"></li>
                                    <li> mysql <img src="<?php echo get_template_directory_uri();?>/images/mysql.svg" alt="Technology 1" class="w-4 h-4 inline-block rounded-full"></li>
                                    <li> python <img src="<?php echo get_template_directory_uri();?>/images/python.svg" alt="Technology 1" class="w-4 h-4 inline-block rounded-full"></li>
                                </ul>
                            </div>
                            <div class="w-full py-4">
                                ...
                                <div class="w-full bg-gray-200 rounded-full h-2 mb-1 dark:bg-gray-700 relative">
                                    <span class="tooltip-box" style="background:#F26829; left:calc(90% - 16px)">
                                        9								
                                    ...
                                    <div class="h-2 rounded-full dark:bg-blue-500" style="width: 90%; background:#F26829;"></div>
                                </div>
                            ...
                            <div class="w-full py-4">
                                ...
                                <div class="w-full bg-gray-200 rounded-full h-2 mb-1 dark:bg-gray-700 relative">
                                    <span class="tooltip-box" style="background:#95C93D; left:calc(80% - 16px)">
                                        8								
                                        <svg class=" absolute bottom-[-8px] left-[7px]" xmlns="http://www.w3.org/2000/svg" width="16" height="10" viewBox="0 0 8 5" fill="none">
                                    ...
                                    <div class="h-2 rounded-full dark:bg-blue-500" style="width: 80%; background:#95C93D;"></div>
                                </div>
                                <p class=" text-[12px] text-[#fff] font-semibold mb-[0px]">0 <span class="float-end">10</span></p>
                            </div>
                            <div class="w-full py-4">
                                ...
                                <div class="w-full bg-gray-200 rounded-full h-2 mb-1 dark:bg-gray-700 relative">
                                    <span class="tooltip-box" style="background:#00C9D3; left:calc(90% - 16px)">
                                        9								
                                        <svg class=" absolute bottom-[-8px] left-[7px]" xmlns="http://www.w3.org/2000/svg" width="16" height="10" viewBox="0 0 8 5" fill="none">
                                    ...
                                    <div class="h-2 rounded-full dark:bg-blue-500" style="width: 90%; background:#00C9D3;"></div>
                                </div>
                                <p class=" text-[12px] text-[#fff] font-semibold mb-[0px]">0 <span class="float-end">10</span></p>
                            </div>
                            <div class="flex flex-wrap -mx-2 mt-4">
                                <div class="w-1/2 px-2 mb-4">
                                    <p class="font-medium text-2xl text-white">£19/hr</p>
                                </div>
                    ...
                    <div class="grid-item col-span-3">
                        <div class="custom-bg custom-border">
                            <div class="flex items-center">
                                <img src="<?php echo get_template_directory_uri();?>/images/09.-Adam-Burrage-Managing-Director.png"  alt="Author" class="w-16 h-16 rounded-full mr-4">
                                <div>
                                    <span class="text-white text-2xl font-medium block">Rahul Sharma</span>
                                    <span class="text-white text-sm font-normal block">Senior Python Developer</span>
                                </div>
                            </div>
                            <div class="grid grid-cols-1 custom-grid-bg sm:grid-cols-2 gap-4 my-7 px-4 py-3 rounded-lg">
                                <div class="flex flex-col sm:flex-row">
                                    ...
                                    <div>
                                        <h3 class="text-sm font-normal pb-2 text-white">Experience</h3>
                                        <p class="text-white text-base font-medium">8 Years</p>
                                    </div>
                                </div>
                                <div class="flex flex-col sm:flex-row">
                                    <img src="<?php echo get_template_directory_uri();?>/images/smallclock.svg" alt="Experience 2" class="w-8 h-8 rounded-lg mb-4 sm:mb-0 sm:mr-4">
                            ...
                            <div class="w-full py-4">
                                <p class=" text-[14px] text-[#fff] font-semibold mb-[8px]">Coding Ability</p>
                                <div class="w-full bg-gray-200 rounded-full h-2 mb-1 dark:bg-gray-700 relative">
                                    <span class="tooltip-box" style="background:#F26829; left:calc(80% - 16px)">
                                        8								
                                        <svg class=" absolute bottom-[-8px] left-[7px]" xmlns="http://www.w3.org/2000/svg" width="16" height="10" viewBox="0 0 8 5" fill="none">
                                        <path d="M3.24372 4.12713C3.6425 4.58759 4.35681 4.58759 4.75558 4.12713L7.89677 0.5H0.102539L3.24372 4.12713Z" fill="#F26829"></path>
                                        </svg>
                                    </span>
                                    <div class="h-2 rounded-full dark:bg-blue-500" style="width: 80%; background:#F26829;"></div>
                                </div>
                                <p class=" text-[12px] text-[#fff] font-semibold mb-[0px]">0 <span class="float-end">10</span></p>
                            </div>
                            <div class="w-full py-4">
                                <p class=" text-[14px] text-[#fff] font-semibold mb-[8px]">Problem Solving</p>
                                <div class="w-full bg-gray-200 rounded-full h-2 mb-1 dark:bg-gray-700 relative">
                                    <span class="tooltip-box" style="background:#95C93D; left:calc(88% - 16px)">
                                        8.8								
                                        <svg class=" absolute bottom-[-8px] left-[7px]" xmlns="http://www.w3.org/2000/svg" width="16" height="10" viewBox="0 0 8 5" fill="none">
                                        <path d="M3.24372 4.12713C3.6425 4.58759 4.35681 4.58759 4.75558 4.12713L7.89677 0.5H0.102539L3.24372 4.12713Z" fill="#95C93D"></path>
                                        </svg>
                                    </span>
                                    <div class="h-2 rounded-full dark:bg-blue-500" style="width: 88%; background:#95C93D;"></div>
                                </div>
                                <p class=" text-[12px] text-[#fff] font-semibold mb-[0px]">0 <span class="float-end">10</span></p>
                            </div>
                            <div class="w-full py-4">
                                <p class=" text-[14px] text-[#fff] font-semibold mb-[8px]">Communication Skills</p>
                                <div class="w-full bg-gray-200 rounded-full h-2 mb-1 dark:bg-gray-700 relative">
                                    <span class="tooltip-box" style="background:#00C9D3; left:calc(96% - 16px)">
                                        9.6								
                                        <svg class=" absolute bottom-[-8px] left-[7px]" xmlns="http://www.w3.org/2000/svg" width="16" height="10" viewBox="0 0 8 5" fill="none">
                                        <path d="M3.24372 4.12713C3.6425 4.58759 4.35681 4.58759 4.75558 4.12713L7.89677 0.5H0.102539L3.24372 4.12713Z" fill="#00C9D3"></path>
                                        </svg>
                                    </span>
                                    <div class="h-2 rounded-full dark:bg-blue-500" style="width: 96%; background:#00C9D3;"></div>
                                </div>
                                <p class=" text-[12px] text-[#fff] font-semibold mb-[0px]">0 <span class="float-end">10</span></p>
                            </div>
                            <div class="flex flex-wrap -mx-2 mt-4">
                                <div class="w-1/2 px-2 mb-4">
                                    <p class="font-medium text-2xl text-white">£22/hr</p>
                                </div>
                                <div class="w-1/2 px-2 mb-4 text-right">
                                    <a href="/contact-us/"> <button class="profile-button-custom"> Hire Now </button> </a>
                                </div>
                    ...
                    <div class="grid-item col-span-3">
                        <div class="custom-bg custom-border">
                            <div class="flex items-center">
                                <img src="<?php echo get_template_directory_uri();?>/images/09.-Adam-Burrage-Managing-Director.png"  alt="Author" class="w-16 h-16 rounded-full mr-4">
                                <div>
                                    <span class="text-white text-2xl font-medium block">Elena Petrova</span>
                                    <span class="text-white text-sm font-normal block">Python Solutions Architect</span>
                                </div>
                            </div>
                            <div class="grid grid-cols-1 custom-grid-bg sm:grid-cols-2 gap-4 my-7 px-4 py-3 rounded-lg">
                                <div class="flex flex-col sm:flex-row">
                                    ...
                                    <div>
                                        <h3 class="text-sm font-normal pb-2 text-white">Experience</h3>
                                        <p class="text-white text-base font-medium">7 Years</p>
                                    </div>
                                </div>
                                <div class="flex flex-col sm:flex-row">
                                    <img src="<?php echo get_template_directory_uri();?>/images/smallclock.svg" alt="Experience 2" class="w-8 h-8 rounded-lg mb-4 sm:mb-0 sm:mr-4">
                            ...
                            <div class="w-full py-4">
                                <p class=" text-[14px] text-[#fff] font-semibold mb-[8px]">Problem Solving</p>
                                <div class="w-full bg-gray-200 rounded-full h-2 mb-1 dark:bg-gray-700 relative">
                                    <span class="tooltip-box" style="background:#95C93D; left:calc(89% - 16px)">
                                        8.9								
                                        <svg class=" absolute bottom-[-8px] left-[7px]" xmlns="http://www.w3.org/2000/svg" width="16" height="10" viewBox="0 0 8 5" fill="none">
                                        <path d="M3.24372 4.12713C3.6425 4.58759 4.35681 4.58759 4.75558 4.12713L7.89677 0.5H0.102539L3.24372 4.12713Z" fill="#95C93D"></path>
                                        </svg>
                                    </span>
                                    <div class="h-2 rounded-full dark:bg-blue-500" style="width: 89%; background:#95C93D;"></div>
                                </div>
                                <p class=" text-[12px] text-[#fff] font-semibold mb-[0px]">0 <span class="float-end">10</span></p>
                            </div>
                            <div class="w-full py-4">
                                <p class=" text-[14px] text-[#fff] font-semibold mb-[8px]">Communication Skills</p>
                                <div class="w-full bg-gray-200 rounded-full h-2 mb-1 dark:bg-gray-700 relative">
                                    <span class="tooltip-box" style="background:#00C9D3; left:calc(88% - 16px)">
                                        8.8								
                                        <svg class=" absolute bottom-[-8px] left-[7px]" xmlns="http://www.w3.org/2000/svg" width="16" height="10" viewBox="0 0 8 5" fill="none">
                                        <path d="M3.24372 4.12713C3.6425 4.58759 4.35681 4.58759 4.75558 4.12713L7.89677 0.5H0.102539L3.24372 4.12713Z" fill="#00C9D3"></path>
                                        </svg>
                                    </span>
                                    <div class="h-2 rounded-full dark:bg-blue-500" style="width: 88%; background:#00C9D3;"></div>
                                </div>
                                <p class=" text-[12px] text-[#fff] font-semibold mb-[0px]">0 <span class="float-end">10</span></p>
                            </div>
                            <div class="flex flex-wrap -mx-2 mt-4">
                                <div class="w-1/2 px-2 mb-4">
                                    <p class="font-medium text-2xl text-white">£21/hr</p>
                                </div>
                                <div class="w-1/2 px-2 mb-4 text-right">
                                    <a href="/contact-us/"> <button class="profile-button-custom"> Hire Now </button> </a>
                                </div>
                ...
                <div class="block text-center mt-12">
                    <a href="#" class="button inline-block align-middle button-small rounded-[30px] px-8 py-4 border-dark-orange border-2 bg-dark-orange text-white text-[16px] hover:bg-transparent hover:text-dark-orange "> FIND A PERFECT DEVELOPER</a>
                </div>
        ...
        <section class="w-full px-3">
            <div class=" w-[100%] max-w-[1280px] mx-auto py-16">
                <div class="block">
                    <div class="text-center small-intro">Proxify</div>
                    <h2 class="text-4xl text-center font-medium text-[35px] md:text-[56px] mb-4 text-white  lg:leading-[60px]">
                        The Proxify way 
                    </h2>
                    <p class="text-center text-white font-medium text-2xl pt-[10px] px-0 mb-10">Say goodbye to never-ending hiring processes,<br>low employee retention, and lack of flexibility.</p>
                </div>
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-3 lg:gap-6">
                    <div class="grid-item col-span-12 lg:col-span-7 turquoiseBlue p-7 rounded-[16px] content-center">
                        <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
                            <div class="grid-item col-span-8">
                                <h5 class=" text-white text-[24px] font-semibold mb-4 leading-[30px]">£20/hour</h5>
                                <p class=" text-white text-[16px] font-normal">The rate for a Python developer with 6+ yrs experience</p>
                            </div>
                            <div class="grid-item col-span-4 text-center">
                                <img class=" h-[150px] w-auto inline-block" src="<?php echo get_template_directory_uri();?>/images/proxy-2.png" alt="">
                            </div>
                        </div>
                    </div>

                    <div class="grid-item col-span-12 lg:col-span-5 burningOrange p-7 rounded-[16px] content-center">
                        <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
                            <div class="grid-item col-span-8">
                                <h5 class=" text-white text-[24px] font-semibold mb-4 leading-[30px]">96% Success</h5>
                                <p class=" text-white text-[16px] font-normal">96% of the developers we place are with the same client 12 months later</p>
                            </div>
                            <div class="grid-item col-span-4 text-center">
                                <img class=" h-[150px] w-auto inline-block" src="<?php echo get_template_directory_uri();?>/images/proxy-1.png" alt="">
                            </div>
                        </div>
                    </div>

                    <div class="grid-item col-span-12 lg:col-span-6 denimBlue p-7 rounded-[16px] content-center">
                        <div class="grid grid-cols-1 lg:grid-cols-12 gap-4">
                            <div class="grid-item col-span-8">
                                <h5 class=" text-white text-[24px] font-semibold mb-4 leading-[30px]">1 M+ Technical Professionals</h5>
                                <p class=" text-white text-[16px] font-normal">Pre-vetted and available to hire in our network </p>
                            </div>
                            <div class="grid-item col-span-4">
                                <img class=" h-[150px] w-auto inline-block" src="<?php echo get_template_directory_uri();?>/images/proxy-3.png" alt="">
                            </div>
                        </div>
                    </div>

                    <div class="grid-item col-span-12 lg:col-span-6 lightPurple p-7 rounded-[16px] content-center">
                        <div class="grid grid-cols-1 lg:grid-cols-12 gap-4">
                            <div class="grid-item col-span-8">
                                <h5 class=" text-white text-[24px] font-semibold mb-4 leading-[30px]">7 Days to Hire</h5>
                                <p class=" text-white text-[16px] font-normal">All engineers are vetted by our team & AI</p>
                            </div>
                            <div class="grid-item col-span-4">
                                <img class=" h-[150px] w-auto inline-block" src="<?php echo get_template_directory_uri();?>/images/proxy-4.png" alt="">
                            </div>
                        </div>
                    </div>
        ...
        <section class="w-full px-3">
            <div class=" w-[100%] max-w-[1280px] mx-auto py-16">
                <div class="block">
                    <div class="text-center small-intro">Pricing</div>
                    <h2 class="text-4xl text-center font-medium text-[35px] md:text-[56px] mb-4 text-white  lg:leading-[60px]">
                        Flexible pricing, without<br><span class="text-dark-orange">the small print</span>
                    </h2>
                            ...
                            <div class="grid grid-cols-1">
                                <div class="grid-item col-span-1 relative pl-[80px] mb-8">
                                    <div class="absolute w-[60px] h-[60px] rounded-[50%] left-0 top-[calc(50%-30px)] overflow-hidden text-center">
                                        <img class="w-[100%] inline-block" src="<?php echo get_template_directory_uri();?>/images/clock-dash.svg" alt="">
                                    </div>
                                    <h6 class="font-semibold text-[25px] text-white">Flexible hours</h6>
                                    <p class="text-white text-[16px]">Regain control and cut fixed costs, from 40 hours per month.</p>
                                </div>
                                <div class="grid-item col-span-1 relative pl-[80px] mb-8">
                                    <div class="absolute w-[60px] h-[60px] rounded-[50%] left-0 top-[calc(50%-30px)] overflow-hidden text-center">
                                        <img class="w-[100%] inline-block" src="<?php echo get_template_directory_uri();?>/images/clock-dash.svg" alt="">
                                ...
                                <div class="grid-item col-span-1 relative pl-[80px]">
                                    <div class="absolute w-[60px] h-[60px] rounded-[50%] left-0 top-[calc(50%-30px)] overflow-hidden text-center">
                                        <img class="w-[100%] inline-block" src="<?php echo get_template_directory_uri();?>/images/clock-dash.svg" alt="">
                                    </div>
                                    <h6 class="font-semibold text-[25px] text-white">Flexible hours</h6>
                ...
                <div class="block text-center mt-10">
                    <a href="#" class="button inline-block align-middle button-small rounded-[30px] px-12 py-4 border-dark-orange border-2 bg-dark-orange text-white text-[16px] hover:bg-transparent hover:text-dark-orange ">GET IN TOUCH</a>
                </div>
            </div>
        </section>
            ...
            <div class=" w-[100%] max-w-[1280px] mx-auto py-16">
                <div class="block">
                    ...
                    <h2 class="text-4xl text-center font-medium text-[35px] md:text-[56px] mb-10 text-white  lg:leading-[60px]">
                        The simple steps to your<br><span class="text-dark-orange">Python developer</span>
                    </h2>
                    <!-- <p class="text-center text-white font-medium text-2xl pt-[10px] px-0 mb-10">Simple terms, tailored to your company.</p> -->
                </div>
                        ...
                        <div class="grid-item col-span-12 lg:col-span-4 mb-10 lg:mb-0 content-center text-center">
                            <div class="block mb-5">
                                <span class="bg-[#fff] inline-block w-[50px] h-[50px] rounded-[10px] p-2 text-center">
                                    <img class="w-[100%]" src="<?php echo get_template_directory_uri();?>/images/accod-1.png" alt="">
                                </span>
                            </div>
                            <h6 class=" text-white text-[25px] font-semibold mb-3">Tell us your requirements</h6>
                            <p class=" text-white text-[16px]">Talk to one of our UK Technical experts about your hiring needs.</p>
                        </div>
                        <div class="grid-item col-span-12 lg:col-span-4 mb-10 lg:mb-0 content-center text-center">
                            <div class="block mb-5">
                                <span class="bg-[#fff] inline-block w-[50px] h-[50px] rounded-[10px] p-2 text-center">
                                    <img class="w-[100%]" src="<?php echo get_template_directory_uri();?>/images/accod-6.png" alt="">
                                </span>
                            </div>
                            <h6 class=" text-white text-[25px] font-semibold mb-3">The matching process</h6>
                            <p class=" text-white text-[16px]">Review top 1% vetted developers, hand picked for you, within days.</p>
                        </div>
                        <div class="grid-item col-span-12 lg:col-span-4 mb-10 lg:mb-0 content-center text-center">
                            <div class="block mb-5">
                                <span class="bg-[#fff] inline-block w-[50px] h-[50px] rounded-[10px] p-2 text-center">
                                    <img class="w-[100%]" src="<?php echo get_template_directory_uri();?>/images/accod-3.png" alt="">
                                </span>
                            </div>
                            <h6 class=" text-white text-[25px] font-semibold mb-3">Becomes part of your team</h6>
                            <p class=" text-white text-[16px]">Flexible contracts and always working your hours.</p>
                        </div>
                    </div>
                </div>
                <div class="block text-center mt-10">
                    <a href="#" class="button inline-block align-middle button-small rounded-[30px] px-12 py-4 border-dark-orange border-2 bg-dark-orange text-white text-[16px] hover:bg-transparent hover:text-dark-orange ">FIND A PERFECT DEVELOPER</a>
                </div>
            </div>
        </section>
        ...
        <section class="w-full px-3">
            <div class=" w-[100%] max-w-[1280px] mx-auto py-16">
                <div class="block">
                    <div class="text-center small-intro">Reviews</div>
                    <h2 class="text-4xl text-center font-medium text-[35px] md:text-[56px] mb-4 text-white  lg:leading-[60px]">
                       <span class="inline-block align-middle">Our</span> <img class="h-[60px] w-auto inline-block align-middle" src="<?php echo get_template_directory_uri();?>/images/our_trusted_review_logo.svg" alt=""> <span class="inline-block align-middle">Reviews</span>
                    </h2>
                    <p class="text-center text-white font-medium text-2xl pt-[10px] px-0 mb-10">Read our reviews to see how our Ai-driven solutions<br>make hiring simpler and more effective.</p>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-10">
                    <div class="trustpilot-bg mb-5">
                        <div class="flex">
                            <div class="pr-4">
                                <img class="mb-7 w-48" src="http://sws.local/wp-content/uploads/2024/08/paul.png" alt="">
                            </div>
                            <div>
                                <p style="color: white; font-size: 16px;">We struggled to fill a Senior Dev-Ops role in the UK. Smartworking-solutions provided quality developers from India, handling all steps from vetting to interviews. They delivered a perfect fit. Highly recommended.</p>
                    ...
                    <div class="trustpilot-bg mb-5">
                        <div class="flex">
                            <div class="pr-4">
                                <img class="mb-7 w-48" src="http://sws.local/wp-content/uploads/2024/08/phil.png" alt="">
                            </div>
                            <div>
                                <p style="color: white; font-size: 16px;">Smart Working built a remote team of 6 developers for us. They quickly integrate, produce high-quality work, and operate like normal team members. We'll keep using Smart Working as we grow. </p>
                    ...
                    <div class="trustpilot-bg mb-5">
                        <div class="flex">
                            <div class="pr-4">
                                <img class="mb-7 w-48" src="http://sws.local/wp-content/uploads/2024/08/steven.png" alt="">
                            </div>
                            <div>
                               
                                <p style="color: white; font-size: 16px;">Smart Working was efficient and easy to work with. They did exactly as described with no pressure or surprises, solving our development resource issues. Our developer integrated well and continues to grow.</p>
                    ...
                    <div class="trustpilot-bg mb-5">
                        <div class="flex">
                            <div class="pr-4">
                                <img class="mb-7 w-48" src="http://sws.local/wp-content/uploads/2024/08/johns.png" alt="">
                            </div>
                            <div>
                                <p style="color: white; font-size: 16px;">Good, efficient process at Smart Working Solutions. They usually onboard new team members within a month of receiving our job description. We also feel well supported by their Indian team.</p>
                    ...
                    <div class="trustpilot-bg mb-5">
                        <div class="flex">
                            <div class="pr-4">
                                <img class="mb-7 w-48" src="http://sws.local/wp-content/uploads/2024/08/callum.png" alt="">
                            </div>
                            <div>
                                
                                <p style="color: white; font-size: 16px;">Smart Working made the process quick and simple. They introduced strong candidates within two days of receiving the job description. We were impressed and highly recommend their service. </p>
                    ...
                    <div class="trustpilot-bg mb-5">
                        <div class="flex">
                            <div class="pr-4">
                                <img class="mb-7 w-48" src="http://sws.local/wp-content/uploads/2024/08/oliver.png" alt="http://Olivar%20trustpiolet%20review">
                            </div>
                            <div>
                                
                                <p style="color: white; font-size: 16px;">We've had a great experience with Smart Working. They made the process easy, and we had a new employee within weeks. Regular check-ins and guidance helped us get the best from our hire. Highly recommended. </p>
        ...
        <!-- <section class="w-full px-3">
            <div class=" w-[100%] max-w-[1280px] mx-auto py-16">
                <div class="block text-center">
                    <h2 class="text-center font-medium text-[35px] md:text-[56px] mb-4 text-white">Prices that work for you</h2>
                </div>
                <div class="block mt-10">
                    <div class="p-[20px] lg:p-[40px] w-[100%] max-w-[700px] mx-auto bg-[#fff] rounded-[20px]">
                        <h6 class="text-center font-extrabold text-[56px] text-dark-black leading-[60px]">£18 &#8212; £22</h6>
                        <p class="text-center font-normal text-[16px] text-dark-black">per developer, per hour</p>
                        ...
                        <div class="block text-center mt-6">
                            <p class="text-center font-normal text-[14px] text-gray-500">No additional costs &#8226; Flexible terms &#8226; Long term support</p>
                        </div>
                    </div>
                </div>
                ...
                <div class=" block relative rounded-[24px] vetting-bg">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-12 content-center gap-4 relative z-10 h-[100%]">
                        <div class="grid-item col-span-1 lg:col-span-5 content-center h-[400px] py-[32px] px-[5%]">
                            <h1 class=" text-white font-bold text-[32px] lg:text-[40px] lg:leading-[45px]">Start building your remote team today</h1>
                            <p class=" text-white text-[16px] mt-[30px] mb-[30px]">Don't let geographical limitations stop you from accessing the best developers.</p>
