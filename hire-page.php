...
<div class=" w-full relative">
	...
	<?php endif; ?>	
					...
					<?php endif; ?>	
						...
						?>
							<div class="block max-w-[860px] mx-auto">
								...
								?>
									<li class="!p-0 !h-auto">
										<a class="block p-6" href="<?php echo get_permalink(); ?>">
											<span class="block text-center"><img class="w-[50px] h-[50px] inline-block" src="<?php echo esc_url($hire_image_src[0]) ;?>" alt="<?php the_title();?>"></span>
		...
		<?php if (have_rows('hire_role_section')) : ?>
			<section class="w-full px-3 py-10" id="count-digit">
				<?php while (have_rows('hire_role_section')) : the_row(); ?>
              ...
              <div class="grid-item col-span-2 content-start">
                <div class=" rounded-[10px] min-h-[100px] p-5 stickysidenav">
							...
							<div class=" w-[100%] min-w-[300px] max-w-[450px] min-h-[300px] bg-[#ff4d04] p-[15px] md:p-[30px] rounded-[16px] relative overflow-hidden ml-auto">
                                ...
                                <p class="text-[30px] font-bold text-[#fff] leading-[40px]"><span class="text-[20px] inline-block align-bottom leading-[36px]">to</span><span class="to-price"><?php echo get_sub_field('right_cta_to_price'); ?></span> <span class="text-[20px] inline-block align-bottom leading-[36px]"> <span class="currency-symble">$</span><?php echo get_sub_field('right_cta_duration'); ?></p>
                                <div class="w-[100%] absolute h-[110px] bg-[rgba(255,255,255,0.4)] left-0 bottom-0 p-[20px] md:px-[30px]">
