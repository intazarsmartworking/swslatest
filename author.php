        ...
        <div class="auther-page-bg">
            <div class="grid grid-cols-1 lg:grid-cols-10">
                ...
                <div class="grid-item col-span-6 p-[20px] lg:p-[70px]">
                    ...
                    <p class="text-white text-[15px] lg:text-[20px] mb-0">CEO and Co-founder</p>
                    ...
                    <p class="text-white text-[13px] lg:text-[24px]">We were founded by Julian Rowse in 2020 <span class="text-[#FFFFFF80]">after the pandemic normalised remote working for</span> so many businesses. Julian has spent over 20 years working with international developers. <span class="text-[#FFFFFF80]">He had a great understanding of the level of skill in the labour</span> force and wanted to give many businesses the opportunity to <span class="text-[#FFFFFF80]">work with exceptionally talented people, who will come at a</span> real cost saving compared to hiring locally.<p>
                </div>
            <div>
        </div>
    ...
    <div class="auther-blog-list w-[100%] max-w-[1280px] mx-auto relative">
        <div class="grid grid-cols-1 lg:grid-cols-10 my-[50px]">
            <div class="grid-item col-span-10 content-center p-3 relative border-b border-[#FF4D0233]">
                <h2 class="text-[#FFF] text-[20px] lg:text-[20px] font-medium mb-0">Written by Julian Rowse</h2>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-10 hover:bg-[#2A0F04] cursor-pointer">
            <div class="grid-item col-span-1 content-center p-3 relative text-center">
                <h2 class="text-[#491804] text-[25px] lg:text-[56px] font-medium mb-0">1</h2>
            </div>
            <div class="grid-item col-span-6 content-center p-3 relative">
                <h1 class="text-white text-[18px] lg:text-[28px] font-medium mb-5">See how Trident simplified cross-border hiring with SmartWorking</h1>
                <p class="text-white text-[13px] lg:text-[16px] font-normal">Mi tincidunt elit, id quisque ligula ac diam, amet. Vel etiam suspendisse morbi eleifend faucibus eget vestibulum felis. Dictum quis montes, sit sit.</p>
            </div>
            <div class="grid-item col-span-3 text-center content-center p-3 relative">
                <img class="blog-img w-[100%] max-w-[220px]" src="<?php echo get_template_directory_uri();?>/images/2023-1.png">
            </div>
        </div>

        <div class="grid grid-cols-1 lg:grid-cols-10 hover:bg-[#2A0F04] cursor-pointer">
            <div class="grid-item col-span-1 content-center p-3 relative text-center">
                <h2 class="text-[#491804] text-[25px] lg:text-[56px] font-medium mb-0">2</h2>
            </div>
            <div class="grid-item col-span-6 content-center p-3 relative">
                <h1 class="text-white text-[18px] lg:text-[28px] font-medium mb-5">See how Trident simplified cross-border hiring with SmartWorking</h1>
                <p class="text-white text-[13px] lg:text-[16px] font-normal">Mi tincidunt elit, id quisque ligula ac diam, amet. Vel etiam suspendisse morbi eleifend faucibus eget vestibulum felis. Dictum quis montes, sit sit.</p>
            ...
            <div class="grid-item col-span-3 text-center content-center p-3 relative">
                <img class="blog-img w-[100%] max-w-[220px]" src="<?php echo get_template_directory_uri();?>/images/2023-2.png">
            </div>
        </div>

        <div class="grid grid-cols-1 lg:grid-cols-10 hover:bg-[#2A0F04] cursor-pointer">
            <div class="grid-item col-span-1 content-center p-3 relative text-center">
                <h2 class="text-[#491804] text-[25px] lg:text-[56px] font-medium mb-0">3</h2>
            </div>
            <div class="grid-item col-span-6 content-center p-3 relative">
                <h1 class="text-white text-[18px] lg:text-[28px] font-medium mb-5">See how Trident simplified cross-border hiring with SmartWorking</h1>
                <p class="text-white text-[13px] lg:text-[16px] font-normal">Mi tincidunt elit, id quisque ligula ac diam, amet. Vel etiam suspendisse morbi eleifend faucibus eget vestibulum felis. Dictum quis montes, sit sit.</p>
            ...
            <div class="grid-item col-span-3 text-center content-center p-3 relative">
                <img class="blog-img w-[100%] max-w-[220px]" src="<?php echo get_template_directory_uri();?>/images/2023-3.png">
            </div>
        </div>

        <div class="grid grid-cols-1 lg:grid-cols-10 hover:bg-[#2A0F04] cursor-pointer">
            <div class="grid-item col-span-1 content-center p-3 relative text-center">
                <h2 class="text-[#491804] text-[25px] lg:text-[56px] font-medium mb-0">4</h2>
            </div>
            <div class="grid-item col-span-6 content-center p-3 relative">
                <h1 class="text-white text-[18px] lg:text-[28px] font-medium mb-5">See how Trident simplified cross-border hiring with SmartWorking</h1>
                <p class="text-white text-[13px] lg:text-[16px] font-normal">Mi tincidunt elit, id quisque ligula ac diam, amet. Vel etiam suspendisse morbi eleifend faucibus eget vestibulum felis. Dictum quis montes, sit sit.</p>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-10 hover:bg-[#2A0F04] cursor-pointer">
            <div class="grid-item col-span-1 content-center p-3 relative text-center">
                <h2 class="text-[#491804] text-[25px] lg:text-[56px] font-medium mb-0">5</h2>
            </div>
            <div class="grid-item col-span-6 content-center p-3 relative">
                <h1 class="text-white text-[18px] lg:text-[28px] font-medium mb-5">See how Trident simplified cross-border hiring with SmartWorking</h1>
                <p class="text-white text-[13px] lg:text-[16px] font-normal">Mi tincidunt elit, id quisque ligula ac diam, amet. Vel etiam suspendisse morbi eleifend faucibus eget vestibulum felis. Dictum quis montes, sit sit.</p>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-10 hover:bg-[#2A0F04] cursor-pointer">
            <div class="grid-item col-span-1 content-center p-3 relative text-center">
                <h2 class="text-[#491804] text-[25px] lg:text-[56px] font-medium mb-0">6</h2>
            </div>
            <div class="grid-item col-span-6 content-center p-3 relative">
                <h1 class="text-white text-[18px] lg:text-[28px] font-medium mb-5">See how Trident simplified cross-border hiring with SmartWorking</h1>
                <p class="text-white text-[13px] lg:text-[16px] font-normal">Mi tincidunt elit, id quisque ligula ac diam, amet. Vel etiam suspendisse morbi eleifend faucibus eget vestibulum felis. Dictum quis montes, sit sit.</p>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-10 my-[50px]">
            <div class="grid-item col-span-10 content-center p-3 relative text-center">
                <a class=" py-4 px-10 rounded-[30px] border bottom-[#fff] text-white text-[20px] hover:bg-[#2A0F04]" href="#">Load more</a>
            </div>
        </div>
