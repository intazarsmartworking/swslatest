		 ...
		 <?php 
            ...
            <div class="grid grid-cols-1 lg:grid-cols-10">
                ...
                <div class="grid-item col-span-6 p-[20px] lg:p-[70px]">
                    <h5 class="text-white text-[20px] lg:text-[40px] font-medium mb-0"><?php echo esc_html($author_name); ?></h5>
	...
	?>
        <div class="grid grid-cols-1 lg:grid-cols-10 my-[50px]">
            <div class="grid-item col-span-10 content-center p-3 relative border-b border-[#FF4D0233]">
                <h2 class="text-[#FFF] text-[20px] lg:text-[20px] font-medium mb-0">Written by <?php echo esc_html($author_name); ?></h2>
            </div>
        </div>
        
		<?php
            // Fetch all posts related to this author
			$counter = 1;
            $post_args = array(
                'post_type' => 'post',
                'meta_query' => array(
                    array(
                        'key' => 'author',  // ACF Relationship field name in the 'post' CPT
                        'value' => '"' . get_the_ID() . '"',
                        'compare' => 'LIKE'
                    )
                )
        ...
        <div class="grid grid-cols-1 lg:grid-cols-10 hover:bg-[#2A0F04] cursor-pointer">
            ...
            <div class="grid-item col-span-6 content-center p-3 relative">
                <h1 class="text-white text-[18px] lg:text-[28px] font-medium mb-5"><?php the_title();?></h1>
                <p class="text-white text-[13px] lg:text-[16px] font-normal"> <?php echo wp_trim_words(get_the_content(), 10); ?> </p>
            </div>
