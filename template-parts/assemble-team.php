<div class="w-full relative py-16">
    ...
    <p class="text-center text-white font-medium text-[18px] md:text-2xl pt-[10px] px-0 "> We strive to connect companies with talented developers worldwide, making it easier to build strong, effective teams </p>
