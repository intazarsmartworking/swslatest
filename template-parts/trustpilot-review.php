...
<div class="w-full relative bg-black grid items-center pb-28">
    <div class="container mx-auto md:px-0 px-10">
        ...
        <div class=" text-5xl sm:text-3xl lg:text-[56px] 3xl:text-58 font-medium gradient-text text-center px-0 flex items-center justify-center w-full md:leading-tight"><span class="mr-[10px]">Our</span><img  src="<?php echo get_template_directory_uri();?>/images/our_trusted_review_logo.svg" alt=""/> <span class="ml-[10px]">Reviews</span> </div>
        <h3 class="text-white text-2xl font-normal text-center py-6 px-0 "> Read our reviews to see how our Ai-driven solutions make hiring simpler and more effective. </h3>
		...
		<div class="header-buttons mt-12 text-center">
		  <a href="https://smartworking.io/" class="button button-small  px-8 py-4 font-bold rounded-xl text-white text-lg get-started-banner-home">See all reviews</a>
		</div>
